...
struct Parser2 final {
  struct Handler {
    ...
    virtual void operator()(
        Trace<deribit::sbe::market_data::Instrument> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 10
    virtual void operator()(
        Trace<deribit::sbe::market_data::TradingStatusUpdate> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 12
    virtual void operator()(
        Trace<deribit::sbe::market_data::InstrumentInfo> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 13
    virtual void operator()(
        Trace<deribit::sbe::market_data::InstrumentRef> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 14
    virtual void operator()(
        Trace<deribit::sbe::market_data::BidPut> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 20
    virtual void operator()(
        Trace<deribit::sbe::market_data::AskPut> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 21
    virtual void operator()(
        Trace<deribit::sbe::market_data::BidQtyReduced> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 22
    virtual void operator()(
        Trace<deribit::sbe::market_data::AskQtyReduced> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 23
    virtual void operator()(
        Trace<deribit::sbe::market_data::BidDelete> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 24
    virtual void operator()(
        Trace<deribit::sbe::market_data::AskDelete> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 25
    virtual void operator()(
        Trace<deribit::sbe::market_data::TradeSummary> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 30
    virtual void operator()(
        Trace<deribit::sbe::market_data::Trade> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 31
    virtual void operator()(
        Trace<deribit::sbe::market_data::BlockTrade> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 33
    virtual void operator()(
        Trace<deribit::sbe::market_data::SnapshotHeader> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 100
    virtual void operator()(
        Trace<deribit::sbe::market_data::SnapshotTrailer> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 101
    virtual void operator()(
        Trace<deribit::sbe::market_data::EndOfCycle> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 119
    virtual void operator()(
        Trace<deribit::sbe::market_data::RetransmitRequest> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 200
    virtual void operator()(
        Trace<deribit::sbe::market_data::RetransmitReject> const &,
        deribit::sbe::market_data::MdMessageHeader const &,
        PacketHeader const &) = 0;  // 202
  };
