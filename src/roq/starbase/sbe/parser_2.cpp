    ...
    while (!std::empty(packet)) {
      ...
      switch (template_id) {
        case deribit_sbe_market_data::Instrument::SBE_TEMPLATE_ID:  // 10
          bytes += dispatch_helper<deribit_sbe_market_data::Instrument>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::TradingStatusUpdate::SBE_TEMPLATE_ID:  // 12
          bytes += dispatch_helper<deribit_sbe_market_data::TradingStatusUpdate>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::InstrumentInfo::SBE_TEMPLATE_ID:  // 13
          bytes += dispatch_helper<deribit_sbe_market_data::InstrumentInfo>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::InstrumentRef::SBE_TEMPLATE_ID:  // 14
          bytes += dispatch_helper<deribit_sbe_market_data::InstrumentRef>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::BidPut::SBE_TEMPLATE_ID:  // 20
          bytes += dispatch_helper<deribit_sbe_market_data::BidPut>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::AskPut::SBE_TEMPLATE_ID:  // 21
          bytes += dispatch_helper<deribit_sbe_market_data::AskPut>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::BidQtyReduced::SBE_TEMPLATE_ID:  // 22
          bytes += dispatch_helper<deribit_sbe_market_data::BidQtyReduced>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::AskQtyReduced::SBE_TEMPLATE_ID:  // 23
          bytes += dispatch_helper<deribit_sbe_market_data::AskQtyReduced>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::BidDelete::SBE_TEMPLATE_ID:  // 24
          bytes += dispatch_helper<deribit_sbe_market_data::BidDelete>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::AskDelete::SBE_TEMPLATE_ID:  // 25
          bytes += dispatch_helper<deribit_sbe_market_data::AskDelete>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::TradeSummary::SBE_TEMPLATE_ID:  // 30
          bytes += dispatch_helper<deribit_sbe_market_data::TradeSummary>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::Trade::SBE_TEMPLATE_ID:  // 31
          bytes += dispatch_helper<deribit_sbe_market_data::Trade>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::BlockTrade::SBE_TEMPLATE_ID:  // 33
          bytes += dispatch_helper<deribit_sbe_market_data::BlockTrade>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::SnapshotHeader::SBE_TEMPLATE_ID:  // 100
          bytes += dispatch_helper<deribit_sbe_market_data::SnapshotHeader>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::SnapshotTrailer::SBE_TEMPLATE_ID:  // 101
          bytes += dispatch_helper<deribit_sbe_market_data::SnapshotTrailer>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::EndOfCycle::SBE_TEMPLATE_ID:  // 119
          bytes += dispatch_helper<deribit_sbe_market_data::EndOfCycle>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::RetransmitRequest::SBE_TEMPLATE_ID:  // 200
          bytes += dispatch_helper<deribit_sbe_market_data::RetransmitRequest>(handler, trace_info, message, message_header, packet_header);
          break;
        case deribit_sbe_market_data::RetransmitReject::SBE_TEMPLATE_ID:  // 202
          bytes += dispatch_helper<deribit_sbe_market_data::RetransmitReject>(handler, trace_info, message, message_header, packet_header);
          break;
        default:
