...
void UDPEvents::operator()(Trace<starbase_sbe::Instrument> const &event, sbe::Frame const &frame) {
...
void UDPEvents::operator()(Trace<starbase_sbe::Book> const &event, sbe::Frame const &frame) {
...
void UDPEvents::operator()(Trace<starbase_sbe::Trades> const &event, sbe::Frame const &frame) {
  auto &trace_info = event.trace_info;
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
...
void UDPEvents::operator()(Trace<starbase_sbe::Ticker> const &event, sbe::Frame const &frame) {
  auto &trace_info = event.trace_info;
  using value_type = std::remove_cvref_t<decltype(event)>::value_type;
...
void UDPEvents::operator()(Trace<starbase_sbe::Snapshot> const &, sbe::Frame const &) {
  log::fatal("Unexpected"sv);
}

void UDPEvents::operator()(Trace<starbase_sbe::SnapshotStart> const &, sbe::Frame const &) {
  log::fatal("Unexpected"sv);
}

void UDPEvents::operator()(Trace<starbase_sbe::SnapshotEnd> const &, sbe::Frame const &) {
  log::fatal("Unexpected"sv);
}

void UDPEvents::operator()(Trace<starbase_sbe::ComboLegs> const &, sbe::Frame const &) {
  log::fatal("Unexpected"sv);
}

void UDPEvents::operator()(Trace<starbase_sbe::PriceIndex> const &, sbe::Frame const &) {
  // XXX FIXME TODO
}

void UDPEvents::operator()(Trace<starbase_sbe::Rfq> const &, sbe::Frame const &) {
  log::fatal("Unexpected"sv);
}

void UDPEvents::operator()(Trace<starbase_sbe::InstrumentV2> const &, sbe::Frame const &) {
