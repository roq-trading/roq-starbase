# [roq-starbase](https://roq-trading.com/docs/reference/gateways/crypto/roq-starbase/)

Roq's Starbase gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-starbase/).
